...
export default function DiarioScreen({ navigation }) {
  ...
  function adicionarEntrada() {
    ...
    const novaEntrada = {
      id: Math.random().toString(), // chave única
      data: dataHoje,
        ...
        {entradas.length > 0 && (
          <LineChart
            ...
            chartConfig={{
              ...
              backgroundGradientFrom: '#ffc3a0', // Light orange
              backgroundGradientTo: '#ffb347', // Orange
              decimalPlaces: 0,
              color: (opacity = 1) => `rgba(220, 20, 60, ${opacity})`, // Crimson
              labelColor: () => '#4b0082', // Dark purple
              propsForDots: {
                r: '6',
                strokeWidth: '2',
