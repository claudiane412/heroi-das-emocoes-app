...
export default function LoginScreen({ navigation, onSkip }) {
    ...
    async function entrar() {
        ...
        try {
            ...
            // ⚠️ Verifique o endpoint de login (deve ser /login minúsculo se você seguiu meu código Node.js)
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput
                ...
                secureTextEntry
            />
            {/* Bloco de link de senha limpo para evitar Unexpected text node */}
            <TouchableOpacity onPress={() => navigation.navigate('EsqueceuSenha')}>
                <Text style={[styles.link, { marginTop: 10, marginBottom: 10, alignSelf: 'flex-end' }]}>
                    Esqueceu sua senha?
                </Text>
            </TouchableOpacity>
